...
public class BookRepositoryJdbcImpl implements BookRepository{
	...
	@Autowired
	private JdbcTemplate jdbcTemplate;  //自動綁定 spring 內建的 JdbcTemplate
	
	@Override
	public List<Book> findAllBooks() {
		// String sql = "* from web.book"; 用 * 犯規 不可以用星號
		String sql = "select id, name, price, amount, pub from web.book";
	...
	public Optional<Book> getBookById(Integer id) {
		String sql = "select id, name, price, amount, pub from web.book where id=?";				
